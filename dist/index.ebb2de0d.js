(function($) {
    ...
    $.fn.mauGallery.methods = {
        createRowWrapper (element) {
            if (!element.children().first().hasClass("row")) element.append('<div class="gallery-items-row row"></div>');
        },
        ...
        prevImage () {
            ...
            if (activeTag === "all") $(".item-column").each(function() {
                if ($(this).children("img").length) imagesCollection.push($(this).children("img"));
            });
            else $(".item-column").each(function() {
                if ($(this).children("img").data("gallery-tag") === activeTag) imagesCollection.push($(this).children("img"));
            });
            let index = 0, next = null;
            $(imagesCollection).each(function(i) {
                if ($(activeImage).attr("src") === $(this).attr("src")) index = i - 1;
            });
        ...
        filterByTag () {
            ...
            $(".gallery-item").each(function() {
                ...
                if (tag === "all") $(this).parents(".item-column").show(300);
                else if ($(this).data("gallery-tag") === tag) $(this).parents(".item-column").show(300);
            });
        }
    };
})(jQuery);

//# sourceMappingURL=index.ebb2de0d.js.map
